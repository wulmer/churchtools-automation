...
def check_nextcloud_settings():
    ...
    expected_config = {
        ...
        "ldapLoginFilter": f"(&(&(|(objectclass=CTPerson))(|(memberof=cn=auto-gruppe: alle mitarbeiter,ou=groups,o={LDAP_SUBDOMAIN})(memberof=cn=auto-gruppe: weitere mitarbeiter,ou=groups,o={LDAP_SUBDOMAIN})))(|(uid=%uid)(|(mailPrimaryAddress=%uid)(mail=%uid))))",
        ...
        "ldapUserFilter": f"(&(|(objectclass=CTPerson))(|(memberof=cn=auto-gruppe: alle mitarbeiter,ou=groups,o={LDAP_SUBDOMAIN})(memberof=cn=auto-gruppe: weitere mitarbeiter,ou=groups,o={LDAP_SUBDOMAIN})))",
